...
@app.route('/createrecipe/create', methods=['POST'])
def addrecipe():
    '''
...
@app.route('/recipe/<recipeid>/pinrecipe', methods=['POST'])
...
@app.route('/groups/<groupid>/<recipeid>/unpinrecipe', methods=['POST'])
def unpinRecipe(recipeid, groupid):
    ...
    conn.close()
    return redirect(url_for('displayrecipe', recipeid=recipeid))
@app.route('/recipe/<recipeid>/reviewrecipe', methods=['POST'])
def reviewrecipe(recipeid):
    ...
    conn.close()
    return redirect(url_for('displayrecipe', recipeid=recipeid))
@app.route('/review/<reviewid>/deletereview', methods=['POST'])
...
@app.route('/user/<followingid>/follow', methods=['POST'])
...
@app.route('/user/<followingid>/unfollow', methods=['POST'])
def unfollowUser(followingid):
    ...
    conn.commit()
    return redirect(url_for('displayuser', userid=followingid))
@app.route('/user/<userid>/manage', methods=['POST'])
...
@app.route('/createaccount/create', methods=['POST'])
def createaccount():
    '''
...
@app.route('/creategroup/create', methods=['POST'])
def creategroup():
    '''
...
@app.route('/group/<groupid>/leave', methods=['POST'])
...
@app.route('/group/<groupid>/join', methods=['POST'])
def joingroup(groupid):
    ...
    conn.close()
    return redirect(url_for('displaygroup', groupid=groupid))
@app.route('/group/<groupid>/delete')
...
@app.route('/group/<groupid>/manage', methods=['POST'])
